                ...
                <div className="flex items-center">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-10 flex items-baseline text-gray-300 font-medium">
                      <NavLink
                        className="px-3 py-2 rounded-md text-sm  hover:text-white hover:bg-gray-700"
                      ...
                      <NavLink
                        className="ml-4 px-3 py-2 rounded-md text-sm hover:text-white hover:bg-gray-700"
                        activeClassName="text-white bg-gray-900"
                        to="/event"
                      >
                        Event
