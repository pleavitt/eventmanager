  ...
  return (
    <div>
      <div className="lg:flex lg:items-center lg:justify-between">
        ...
        Closing on {format(event.start, "MMM, dd yyy")}
            </div>
          </div>
        </div>
        ...
        View
          ...
          <span className="ml-3 relative shadow-sm rounded-md sm:hidden">
            <button onClick={() => setIsDropdownOpen(!isDropdownOpen)} type="button" className="inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:shadow-outline focus:border-blue-300 transition duration-150 ease-in-out" id="mobile-menu" aria-haspopup="true">
